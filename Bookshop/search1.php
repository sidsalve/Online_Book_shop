...
$q=mysql_query("select * from book where bname like '%$bname%'") or die(mysql_error());

                echo"You Search For:<br>Stream:<font color=red>".$stream."</font>&nbsp;&nbsp;&nbsp;Class:<font color=red>".$class."</font>&nbsp;&nbsp;&nbsp;Year:<font color=red>".$year."</font>";
     

$n=0;
while($row=mysql_fetch_array($q))
{
    if($row['stream']==$stream && $row['class']==$class && $row['year']==$year)
    {
        $n=1;
        $id=$row['bid'];
