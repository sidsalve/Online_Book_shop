<html>
    <head>
        <title>Search:Biography Books</title>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  <table width="584" height="245" border="0" align="center">
    <tr>
      <td colspan="2"><div align="center"><strong><span class="style2">Search Biography Book</span></strong></div></td>
    </tr>
    <tr>
...
else
{
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
        ...
        $n=0;
        echo"<font size=4 color='blue'>Search Result</font>";
