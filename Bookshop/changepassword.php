...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  <table width="523" height="227" border="0" align="center">
    <tr>
      <td colspan="2"><div align="center"><strong><span class="style2">Change Password </span></strong></div></td>
    </tr>
    <tr>
      <td width="172">Enter Old Password:</td>
      <td width="204"><input name="old" type=password id="old" required></td>
    </tr>
    <tr>
      <td width="172">Enter New Password: </td>
      <td><input name="pass" type="password" id="pass" value="" required></td>
    </tr>
    <tr>
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
       ...
       $old=$_POST['old'];
        ...
        $cp=$_SESSION['pass'];
         ...
         $match=mysql_query("select * from signup where uid='$p'");
        ...
        if($pass==$cpass)
        {
            $qry="UPDATE signup SET pass='$pass',cpass='$cpass' WHERE uid='$p'";
            $result=mysql_query($qry);
            if($result)
            {
                echo"<center><font color=purple size=6>Password Changed Successfuly</font><br>";
