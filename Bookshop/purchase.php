...
<table width="612" border="0">
  ...
  <tr>
    ...
    echo $_SESSION['bname']."</font><b>&nbsp;&nbsp;:::&nbsp;&nbsp;"; echo"<b>Author Name:<font color=red>";
  ...
  <tr>
    ...
    <?php $_SESSION['price']=$row['price']; ?>
        ...
        <fieldset><legend><b>Fill Your Purchasing Details</b></legend>
            <br/><br/><fieldset><legend><font color=purple>Pay Cash-On-Delivery</font></legend>
            Please Check Your Name:<input type="text" name="fullname" value="<?php echo $_SESSION['fullname'];?>"><br><br>
            Please Check Your Address:<input type="text" rows="3" cols="30" name="address" value="<?php echo $permanant;?>"><br><br>
            Please Check Your Contact NO.:<input type="text" name="contact" value="<?php echo $contact;?>"><br><br>
            ...
            <br/><br/><fieldset><legend><font color=purple>Pay Online Banking</font></legend><br>
            ...
            3 Digit CVV Code on card:<input type="password" name="puk" required maxlength="3"><br><br>
