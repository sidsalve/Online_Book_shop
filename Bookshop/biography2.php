...
?>
    ...
    <a href="bussiness3.php">Bussiness</a>
        ...
        <center><font size="5" color="red">******* Biography Book *******</font></center>
...
<div class="content1">
 ...
 <table width="612" border="0">
  ...
  <tr>
    ...
    echo $row['bname']."</font></b>&nbsp;&nbsp;:::&nbsp;&nbsp;"; echo"<b>Author Name:<font color=#008080>";
    echo $row['author']."</font></b>";?></td>
  </tr>
  <tr>
    <td><?php echo"<b>Publication:<font color=#800080>";
    echo $row['publication']."</font></b>&nbsp;&nbsp;:::&nbsp;&nbsp;"; echo"<b>Edition:<font color=#808000>";
  ...
  <tr>
    ...
    echo $row['lang']."</font><b>&nbsp;&nbsp;:::&nbsp;&nbsp;";?><a href="purchase1.php?bid=<?php echo $bid; ?>">Purchase Book</a></td>
  </tr>
</table>
        </div>
    ...
    <?php
        ...
        if(!$n==1)
    {
        echo"<h1>Sorry,Biography Books are not available please try another category</h1>";
    }
