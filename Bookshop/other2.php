...
?>
<div class="content1">
    <center><font size="6" color="blue">*******</font><font size="5" color="red">Other Category Books</font><font size="6" color="blue"> *******</font></center>
 <table width="612" border="0">
  ...
  <tr>
    ...
    <?php
        ...
        if(!$n==1)
    {
        echo"<h1>Sorry,Other Category Books are not avilable please try another category</h1>";
    }
