...
?>
    ...
    <div class="content3">
        <font size=4 color="white">
            ...
            <img src="tball.gif" width="14" height="14">
            <a href="login1.php"><font color="white">Login</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <a href="bussiness3.html">Business</a>
    ...
    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true)
    {
echo"<center><font size=6 color=blue>You Are Already Login,For New Login Logout First...</font></center>";
    }
            else
            {
?>
...
<div class="login" >
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <fieldset><center> <font face="Bauhaus 93" size="7" color="green">L</font><font face="Bauhaus 93" size="7" color="blue">O</font><font face="Bauhaus 93" size="7" color="red">G</font><font face="Bauhaus 93" size="7" color="silver">I</font><font face="Bauhaus 93" size="7" color="yellow">N</font></center><hr>
                        <form action="login.php" method="post">

            User Name:<input type="text" name="uname"  placeholder="Enter User Name" required><br><br>
            &nbsp;&nbsp;&nbsp;Password:<input type="password" name="pass" placeholder="Enter Password" required><br><br><hr>
                            <div class="col-xs-4">
                        <input type="submit" class="btn pull-right" style="background-color:blue;color:white" value="Log In">  
                    </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="signup1.php">SignUp</a>(create new account)</form></fieldset>
