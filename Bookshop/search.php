...
$q=mysql_query("select * from book") or die(mysql_error());
            ...
            $n7=$_POST['n7'];
            $n8=$_POST['n8'];
                echo"You Search For:<br>Stream:<font color=red>".$n6."</font>&nbsp;&nbsp;&nbsp;Class:<font color=red>".$n7."</font>&nbsp;&nbsp;&nbsp;Year:<font color=red>".$n8."</font>";
        if($n6=="" || $n7=="" || $n8=="")
        {
            echo"<h1>Please Select Somthing</h1>";
        }
        else
        {
...
{
    if($row['stream']==$n6 && $row['class']==$n7 && $row['year']==$n8)
    {
        $n=1;
        $id=$row['bid'];
 ...
 <table width="612" border="0">
  ...
  <tr>
    ...
    echo $row['price']."</u></font></b>&nbsp;&nbsp;:::&nbsp;&nbsp;"; echo"<b>Available in:<font color=red>";
        echo $row['lang']."</font><b>&nbsp;&nbsp;:::&nbsp;&nbsp;";?><a href="purchase.php?bid=<?php echo $id; ?>">Purchase Book</a></td>
  </tr>
</table><br><br>
            <?php
    }
    ...
    if(!$n==1)
    {
        echo"<h1>Sorry,This type of Book is NOT Available</h1>";
    }
