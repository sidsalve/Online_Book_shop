...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  <table width="559" height="162" border="0" align="center">
    <tr>
      <td colspan="2"><div align="center"><strong><span class="style2">Change Address </span></strong></div></td>
    </tr>
    <tr>
      <td width="172">Enter New Residential Address : </td>
        <td width="204"><textarea name="residential" type="text" id="residential" rows="3" cols="30"></textarea></td>
    </tr>
    <tr>
      <td width="172">Enter New Permanant Address </td>
        <td><textarea name="permanant" type="text" id="permanant" rows="3" cols="30"></textarea></td>
    </tr>
    <tr>
   ...
   else
{
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
       $residential=$_POST['residential'];
        ...
        if(!empty($residential) || !empty($permanant))
        {
            mysql_connect("localhost","root","") or die("can not connect");
            mysql_select_db("bookshop") or die("can not connect");
            $qry="UPDATE signup SET residential='$residential',permanant='$permanant' WHERE uid='$p'";
            $result=mysql_query($qry);
            if($result)
            {
                echo"<center><font color=red size=6>Address Changed Successfuly</font><br>";
                echo"New Residential Address Is:".$residential."<br>";
                echo"New Permanant Address Is:".$permanant."<br></center>";
