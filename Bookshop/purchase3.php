...
mysql_select_db("bookshop") or die("can not connect");
        ...
        $d_status='In Process';
             if(isset($_POST['cash']))
             {
             $qry="insert into purchase values('$pid','$bid','$uid','$date','$payment','$bank_name','$ifsc','$card','$pukcode',' $d_status')";
                 
            $result=mysql_query($qry);
            if($result)
            {
                echo"<center><font size=6 color=red>Hello&nbsp;</font><font size=6 color=purple>".$_SESSION['fullname']."</font><br>";
                echo"<font size=6 color=blue>Thank You To Purchased&nbsp;</font><font size=6 color=crimson>'".$_SESSION['bname']."'</font><br>";
                echo"<font size=6 color=#7fff00>You Pay:</font><font size=6 color=#8b008b>".$_SESSION['price']."Rs. Only</font><br>";
                echo"<font size=6 color=#ff00ff>Your Book Is Deliver Within 10 Days..!!";
                echo"</font></center>";
