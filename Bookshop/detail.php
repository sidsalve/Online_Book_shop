...
while($row=mysql_fetch_array($result))
{
    ...
    {
    ?>
            <fieldset><legend align=center><font size=6 color="purple">****Book Detail****</font></legend>
<CENTER><img height="240" width="210" src="data:image;base64,<?php echo $row[14]; ?>"><br>
    <font size=5 color="">Book Name:</font><font size=5 color=red><?php echo $row['bname']; ?></font><br>
    <font size=5 color="">Author Name:</font><font size=5 color=red><?php echo $row['author']; ?></font><br>
    <font size=5 color="">Publication:</font><font size=5 color=red><?php echo $row['publication']; ?></font><br>
    <font size=5 color="">Edition:</font><font size=5 color=red><?php echo $row['edition']; ?></font><br>
    <font size=5 color="">Category:</font><font size=5 color=red><?php echo $row['category']; ?></font><br>
    <font size=5 color="">Stream:</font><font size=5 color=red><?php echo $row['stream']; ?></font><br>
    <font size=5 color="">Class:</font><font size=5 color=red><?php echo $row['class']; ?></font><br>
    <font size=5 color="">Year:</font><font size=5 color=red><?php echo $row['year']; ?></font><br>
    <font size=5 color="">Pages:</font><font size=5 color=red><?php echo $row['pages']; ?></font><br>
    <font size=5 color="">Price:</font><font size=5 color=red><u><?php echo $row['price']; ?></u></font><br>
    <font size=5 color="">Available In:</font><font size=5 color=red><?php echo $row['lang']; ?></font><br>
    <font size=5 color="">ISBN No.:</font><font size=5 color=red><?php echo $row['isbn']; ?></font><br>
    <font size=5><a href="purchase.php?bid=<?php echo $bid; ?>">Purchase Book</a></font><br><br>
    <input type="button" value="Back" onclick="history.go(-1);"><br></CENTER></fieldset>
...
<CENTER><img height="240" width="210" src="data:image;base64,<?php echo $row[14]; ?>"><br>
    ...
    <font size=5 color="">Available In:</font><font size=5 color=red><?php echo $row['lang']; ?></font><br>
    <font size=5 color="">ISBN No.:</font><font size=5 color=red><?php echo $row['isbn']; ?></font><br>
    <font size=5><a href="purchase1.php?bid=<?php echo $bid; ?>">Purchase Book</a></font><br><br>
    <input type="button" value="Back" onclick="history.go(-1);"><br></CENTER></fieldset>
