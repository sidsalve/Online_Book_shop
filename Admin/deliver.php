<html>
    ...
    ?>
        <center><font size=5 color=blue>Deliver Orders</font>
        <table border="0" width=100%>
            <tr bgcolor=red><th >Purchase ID</th><th>Book ID</th><th>User ID</th><th>Date</th><th>Pay Type</th><th>Bank Name</th><th>IFSC Code</th><th>Card Type</th><th>Delivery Status</th></tr>
        <?php
